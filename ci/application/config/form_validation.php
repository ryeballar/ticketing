...
$config['member/signup'] = array(
	...
	rule('member[password]', 'Password', normal_text('max_length[50]')),
	rule('confirm_password', 'Confirm Password', normal_text('max_length[50]|callback__check_password_confirmed'))
);
